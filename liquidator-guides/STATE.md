...
Last updated: 2026-09-20T01:20Z (07A done + committed 8a33525; 02B done 6e02280; 03A done 972c98f; C1 univ3 re-sweep running)
...
| 07B | FlashIndex, eligibility, selection, cascade | 07A | — | T1 | `in_progress` | coord-02 2026-09-20T01:22Z (builder 815c5a70, Fable 5.1) | FlashIndex (by_asset SmallVec, <100ns no-alloc) + DepthOnlyRouteCache stub + eligibility (two-sided, all repay_options, Unfundable bitset mark-never-delete) + selection (effective cost ranking) + cascade (≤3 sibling groups, floor(avail*99/100), no nesting). Deferred: live-sampling→post-A2, route-depth→12A-1, gas_overhead→10C, re-encode→12A-2. Carry-forward from 07A: V3 abs fee ceil, ApplyCtx flash dispatch slice |
