...
pub fn listing_logs(d: &Deploy) -> Vec<OwnedLog> {
    ...
    vec![
        ...
        log(
            ...
            &ev::TroveOperation {
                troveId: d.trove_id,
                operation: ev::op::OPEN_TROVE,
                annualInterestRate: U256::ZERO,
                debtIncreaseFromRedist: U256::ZERO,
                debtIncreaseFromUpfrontFee: U256::ZERO,
                debtChangeFromOperation: alloy_primitives::I256::try_from(ALICE_DEBT).unwrap(),
                collIncreaseFromRedist: U256::ZERO,
                collChangeFromOperation: alloy_primitives::I256::try_from(ALICE_COLL).unwrap(),
            },
            b,
            t,
        ),
